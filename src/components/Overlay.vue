...
#pepin-sidebar .pepin-sidebar-inner
{
  padding: 16px;
}
...
.pepin-sidebar h1
{
    ...
    border-bottom: 1px solid rgb(192,192,216);
    text-align: center;
    font-weight: normal;
    clear: both;
}

.pepin-sidebar table.pepin-infos
{
  padding: 4px;
  width: 100%;
}

.pepin-sidebar table.pepin-infos tr
{
    padding: 8px;
    color: #fff;
}

.pepin-sidebar table.pepin-infos td
{
...
.pepin-sidebar table.pepin-infos th
{
